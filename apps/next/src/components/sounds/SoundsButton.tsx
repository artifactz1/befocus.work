...
//     <main>
//       {!isDeleteMode ? (
//         // <div className='relative border-2 space-y-3 p-4 rounded-lg overflow-hidden'>
//         // <div className='relative overflow-hidden border-2 space-y-3 p-4 rounded-lg h-fit'>
//         // <div className='relative border-2 space-y-3 p-4 rounded-lg overflow-hidden'>
//         <div className='relative border-2 space-y-3 p-4 rounded-lg overflow-hidden min-h-fit flex flex-col'>
    ...
    <main>
      {!isDeleteMode ? (
        <Card className="relative overflow-hidden ">
          ...
          {/* // Option 1: Always render with conditional opacity (Recommended) */}
