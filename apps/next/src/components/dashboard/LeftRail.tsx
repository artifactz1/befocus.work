...
export default function LeftRail() {
  return (
    <div
      ...
      className='[&_button]:h-9 [&_button]:w-9 [&_button]:rounded-full [&_button]:border-0 [&_button]:bg-transparent [&_button]:text-muted-foreground [&_button]:shadow-none [&_button]:transition-colors [&_button:hover]:bg-foreground/10 [&_button:hover]:text-foreground fixed left-4 top-1/2 z-30 hidden -translate-y-1/2 flex-col items-center gap-1 rounded-full border border-border/40 bg-card/60 p-1.5 shadow-[0_20px_60px_-30px_rgba(0,0,0,0.55)] backdrop-blur-xl sm:flex md:left-6'
    >
      <ToDoList />
      <SoundSettings />
      <SessionSettings />
