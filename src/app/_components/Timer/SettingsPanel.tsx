...
interface SettingsPanelProps {
  ...
  workDuration: number;
  breakDuration: number;
  handleSettingsChange: (key: keyof Settings, value: number) => void; // Match type
}
...
const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  // console.log("Current settings passed to SettingsPanel:", Settings);
              ...
              <div className="grid w-[400px] gap-3 p-4 md:w-[500px] lg:w-[600px]">
                <div className="rounded-md bg-card p-6 shadow-md">
                  ...
                  <Settings
                    ...
                    breakDuration={breakDuration / 60} // Convert to minutes for display
